...
<button class="accordion" onclick="collapsable()">Registration is closed</button>

<p> Thank you so much for your interest! Our venue has reached its maximum capacity and can no longer accommodate any more guests.</p>
